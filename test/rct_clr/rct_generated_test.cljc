...
(defn- rct-clr-gen-rct-block-2 []
  ;; gen.cljc:171
  (testing "gen.cljc:171" (rct-clr.rct-generated-test/run-form! "gen.cljc:171" (quote (clojure.test/is (= 42 (rct-clr.rct-generated-test/bind-repl-vars! (read-expectation {:expectation-type (quote =>), :expectation-string "42"} (quote rct-clr.gen))))))))
  ;; gen.cljc:176
  (testing "gen.cljc:176" (rct-clr.rct-generated-test/run-form! "gen.cljc:176" (quote (clojure.test/is (= [1 2] (rct-clr.rct-generated-test/bind-repl-vars! (read-expectation {:expectation-type (quote =>>), :expectation-string "[1 2 ...]"} (quote rct-clr.gen))))))))
  ;; gen.cljc:181
  (testing "gen.cljc:181" (rct-clr.rct-generated-test/run-form! "gen.cljc:181" (quote (clojure.test/is (= nil (rct-clr.rct-generated-test/bind-repl-vars! (read-expectation {:expectation-type (quote =>), :expectation-string nil} (quote rct-clr.gen))))))))
  ;; gen.cljc:187
  (testing "gen.cljc:187" (rct-clr.rct-generated-test/run-form! "gen.cljc:187" (quote (clojure.test/is (= (quote (+ 1 2)) (rct-clr.rct-generated-test/bind-repl-vars! (read-expectation {:expectation-type (quote =>), :expectation-string "(+ 1 2)"} (quote rct-clr.gen))))))))
  ;; gen.cljc:193
  (testing "gen.cljc:193" (rct-clr.rct-generated-test/run-form! "gen.cljc:193" (quote (clojure.test/is (= :clr (rct-clr.rct-generated-test/bind-repl-vars! (read-expectation {:expectation-type (quote =>), :expectation-string "#?(:clj :jvm :cljr :clr)"} (quote rct-clr.gen))))))))
  ;; gen.cljc:199
  (testing "gen.cljc:199" (rct-clr.rct-generated-test/run-form! "gen.cljc:199" (quote (clojure.test/is (= :rct-clr.gen/foo (rct-clr.rct-generated-test/bind-repl-vars! (read-expectation {:expectation-type (quote =>), :expectation-string "::foo"} (quote rct-clr.gen))))))))
  ;; gen.cljc:205
  (testing "gen.cljc:205" (rct-clr.rct-generated-test/run-form! "gen.cljc:205" (quote (clojure.test/is (= :clojure.string/join (rct-clr.rct-generated-test/bind-repl-vars! (read-expectation {:expectation-type (quote =>), :expectation-string "::string/join"} (quote rct-clr.gen))))))))
  ;; gen.cljc:211
  (testing "gen.cljc:211" (rct-clr.rct-generated-test/run-form! "gen.cljc:211" (quote (clojure.test/is (= 3 (rct-clr.rct-generated-test/bind-repl-vars! (count (read-expectation {:expectation-type (quote =>), :expectation-string "[1 2 ...]"} (quote rct-clr.gen)))))))))
  ;; gen.cljc:217
  (testing "gen.cljc:217" (rct-clr.rct-generated-test/run-form! "gen.cljc:217" (quote (try (read-expectation {:expectation-type (quote =>), :expectation-string "[1 2"} (quote rct-clr.gen)) (clojure.test/is false "Expected exception") (catch System.Exception e (set! *e e) (matcho.core/assert {} (rct-clr.rct-generated-test/error->map e))))))))
(defn- rct-clr-gen-rct-block-3 []
  ;; gen.cljc:246
  (testing "gen.cljc:246" (rct-clr.rct-generated-test/run-form! "gen.cljc:246" (quote (clojure.test/is (= (quote (test-output-ns/bind-repl-vars! (def x 1))) (rct-clr.rct-generated-test/bind-repl-vars! (datum->form {:expectation-type nil, :test-sexpr (quote (def x 1))} (quote rct-clr.gen) (quote test-output-ns))))))))
  ;; gen.cljc:253
  (testing "gen.cljc:253" (rct-clr.rct-generated-test/run-form! "gen.cljc:253" (quote (clojure.test/is (= (quote (clojure.test/is (= 3 (test-output-ns/bind-repl-vars! (+ 1 2))))) (rct-clr.rct-generated-test/bind-repl-vars! (datum->form {:expectation-type (quote =>), :test-sexpr (quote (+ 1 2)), :expectation-string "3"} (quote rct-clr.gen) (quote test-output-ns))))))))
  ;; gen.cljc:261
  (testing "gen.cljc:261" (rct-clr.rct-generated-test/run-form! "gen.cljc:261" (quote (clojure.test/is (= (quote (clojure.test/is (= (quote (1 2 3)) (test-output-ns/bind-repl-vars! (sizes))))) (rct-clr.rct-generated-test/bind-repl-vars! (datum->form {:expectation-type (quote =>), :test-sexpr (quote (sizes)), :expectation-string "'(1 2 3)"} (quote rct-clr.gen) (quote test-output-ns))))))))
  ;; gen.cljc:269
  (testing "gen.cljc:269" (rct-clr.rct-generated-test/run-form! "gen.cljc:269" (quote (clojure.test/is (= (quote (clojure.test/is (= (+ 2 2) (test-output-ns/bind-repl-vars! (size))))) (rct-clr.rct-generated-test/bind-repl-vars! (datum->form {:expectation-type (quote =>), :test-sexpr (quote (size)), :expectation-string "(+ 2 2)"} (quote rct-clr.gen) (quote test-output-ns))))))))
  ;; gen.cljc:277
  ...
  ;; gen.cljc:285
  (testing "gen.cljc:285" (rct-clr.rct-generated-test/run-form! "gen.cljc:285" (quote (clojure.test/is (= (quote (try (boom!) (clojure.test/is false "Expected exception") (catch System.Exception e (set! *e e) (matcho.core/assert #:error{:class Exception} (test-output-ns/error->map e))))) (rct-clr.rct-generated-test/bind-repl-vars! (datum->form {:expectation-type (quote throws=>>), :test-sexpr (quote (boom!)), :expectation-string "{:error/class Exception}"} (quote rct-clr.gen) (quote test-output-ns)))))))))
